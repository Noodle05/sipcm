 ...
 * 
 */
public abstract class AbstractDAOHibernate<Entity extends Serializable, ID extends Serializable>
	...
	public ID getEntityId(Entity entity) {
		...
		ID id = null;
		if (entity != null && sf != null) {
			ClassMetadata cm = sf.getClassMetadata(getEntityName());
			if (cm != null) {
				id = (ID) cm.getIdentifier(entity, EntityMode.POJO);
				if (logger.isTraceEnabled()) {
