...
ADD INDEX FK8097D622B8A26B8B (role_id),
ADD CONSTRAINT FK8097D622B8A26B8B FOREIGN KEY (role_id) REFERENCES tbl_role (id);

ALTER TABLE tbl_userrole
ADD INDEX FK8097D6225DCD2F6B (user_id),
ADD CONSTRAINT FK8097D6225DCD2F6B FOREIGN KEY (user_id) REFERENCES tbl_user (id);
