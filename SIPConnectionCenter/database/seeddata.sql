INSERT INTO tbl_role (createdate, name, description) VALUES (NULL, 'caller', 'Role for callers');
INSERT INTO tbl_role (createdate, name, description) VALUES (NULL, 'admin', 'System administrator');
