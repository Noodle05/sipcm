...
public class Settings implements Serializable {
	...
	public String primaryDid;
	public transient String language;
	public int screenBehavior;
	public boolean useDidAsCallerId;
	public transient int spam;
	public transient int credits;
	public transient String timezone;
	public transient boolean doNotDisturb;
	public transient Object[] didInfos;
	public transient Notification[] smsNotifications;
	public transient boolean emailNotificationActive;
	public transient String emailNotificationAddress;
	public transient boolean smsToEmailActive;
	public transient boolean smsToEmailSubject;
	public transient boolean missedToEmail;
	public transient boolean showTranscripts;
	public transient boolean directConnect;
	public transient boolean useDidAsSource;
	public transient boolean emailToSmsActive;
	public transient boolean missedToInbox;
	public transient Greeting[] greetings;
	public transient Map<Integer, Greeting> greetingMap;
	public int[] activeForwardingIds;
	public Map<Integer, Boolean> disabledIdMap;
	public transient int defaultGreetingId;
	public transient Object[] webCallButtons;
	public transient Map<Integer, Group> groups;
	public transient int[] groupList;
	public transient boolean lowBalanceNotificationEnabled;
