 ...
 * 
 */
@Component("sipClientMessageProcessor")
public class SipClientMessageProcessor implements SipRequestProcessor,
		SipResponseProcessor, SipTimeoutProcessor,
		SipTransactionTerminatedProcessor, SipIOExceptionProcessor,
		SipDialogTerminatedProcessor {
	/*
	 * (non-Javadoc)
	 * 
	 * @see
