...
public class UserSipProfileServiceEventObserver extends
	...
	@Around("target(com.mycallstation.sip.business.UserSipProfileService) && execution(* saveEntity(..)) && args(userSipProfile)")
	...
	@Around("target(com.mycallstation.sip.business.UserSipProfileService) && execution(* saveEntity(..)) && args(userSipProfiles)")
	...
	@AfterReturning(pointcut = "target(com.mycallstation.sip.business.UserSipProfileService) && execution(* removeEntity*(..))", returning = "userSipProfile")
	public final void entityDeleted(UserSipProfile userSipProfile) {
		afterDeleteEntity(userSipProfile);
	}

	@AfterReturning(pointcut = "target(com.mycallstation.sip.business.UserSipProfileService) && execution(public * removeEntityById*(..))", returning = "userSipProfile")
	public final void entityDeletedById(UserSipProfile userSipProfile) {
		afterDeleteEntity(userSipProfile);
	}

	@AfterReturning(pointcut = "target(com.mycallstation.sip.business.UserSipProfileService) && execution(* removeEntities(..))", returning = "userSipProfiles")
