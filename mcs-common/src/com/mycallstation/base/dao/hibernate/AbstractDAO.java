...
public abstract class AbstractDAO<Entity extends Serializable, ID extends Serializable>
    ...
    public List<Entity> getEntities(final Filter filter, final Sort sort,
        ...
        List<Entity> ret = getHibernateTemplate().execute(
    ...
    public List<ID> getEntityIds(final Filter filter, final Sort sort,
        ...
        List<ID> ret = getHibernateTemplate().execute(
    ...
    private Query setParameter(Query query, int index, Object value) {
        if (logger.isTraceEnabled()) {
            logger.trace(
                    ...
                    new Object[] { query.getQueryString(), index, value });
        }
        String parameterName = "param_" + index;
        Query ret;
        if (value instanceof Boolean) {
            ret = query.setBoolean(parameterName,
                    ((Boolean) value).booleanValue());
        } else if (value instanceof Byte) {
            ret = query.setByte(parameterName, ((Byte) value).byteValue());
        } else if (value instanceof Character) {
            ret = query.setCharacter(parameterName,
                    ((Character) value).charValue());
        } else if (value instanceof Double) {
            ret = query
                    .setDouble(parameterName, ((Double) value).doubleValue());
        } else if (value instanceof Float) {
            ret = query.setFloat(parameterName, ((Float) value).floatValue());
        } else if (value instanceof Integer) {
            ret = query.setInteger(parameterName, ((Integer) value).intValue());
        } else if (value instanceof Long) {
            ret = query.setLong(parameterName, ((Long) value).longValue());
        } else if (value instanceof Short) {
            ret = query.setShort(parameterName, ((Short) value).shortValue());
        } else if (value instanceof String) {
            ret = query.setString(parameterName, (String) value);
        } else if (value instanceof byte[]) {
            ret = query.setBinary(parameterName, (byte[]) value);
        } else if (value instanceof BigDecimal) {
            ret = query.setBigDecimal(parameterName, (BigDecimal) value);
        } else if (value instanceof BigInteger) {
            ret = query.setBigInteger(parameterName, (BigInteger) value);
        } else if (value instanceof Date) {
            ret = query.setDate(parameterName, (Date) value);
        } else if (value instanceof Time) {
            ret = query.setTime(parameterName, (Time) value);
        } else if (value instanceof Timestamp) {
            ret = query.setTimestamp(parameterName, (Timestamp) value);
        } else if (value instanceof java.util.Date) {
            ret = query.setTimestamp(parameterName, (java.util.Date) value);
        } else if (value instanceof Locale) {
            ret = query.setLocale(parameterName, (Locale) value);
        } else if (value instanceof Collection) {
            ret = query.setParameterList(parameterName, (Collection<?>) value);
        } else {
            ret = query.setParameter(parameterName, value);
        }
        return ret;
    }
